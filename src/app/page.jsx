...
<div >
      ...
      <Link href= 'signUp'>
            <p className='text-center mt-10'><button className='capitalize font-medium text-white text-2xl w-40 h-[45px] rounded-2xl m-auto justify-evenly bg-blue-500 hover:bg-blue-800 content-center'>Let's Start</button></p>
            </Link>
